...
public class PassengerServiceImpl implements PassengerService {
	...
	@Override
	public Passenger viewPassenger(BigInteger uin) {
		Optional<Passenger> optional = passengerDao.findById(uin);
		if (optional.isPresent()) {
			Passenger passenger = optional.get();
			return passenger;
		}
		throw new PassengerNotFoundException("Passengers not found for pnrNo=" + uin);
	}
//
//	@Override
...
//
	@Override
	public void deletePassenger(BigInteger uin) {
